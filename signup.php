  ...
  <div class="container__child signup__form">
    <form action="includes/signup.inc.php" method="post">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="mail" id="email" placeholder="username@cybergence.com" required />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="password" name="pwd-repeat" id="passwordRepeat" placeholder="********" required />
	  </div>
	  <br>
      <div class="m-t-lg">
